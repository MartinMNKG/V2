...
def Change_detailed(time_list,temp_list,Y_target_list,Y_non_target_list,case,target,non_target,param):
    ...
    if info_scal =="scaler" :
        ...
        ai_delay,ai_delay_scaler = standard_T(ai_delay,case)
    
    return time_list,temp_list,Y_target_list,Y_non_target_list,Y_scaler_Targets,Y_scaler_Non_Targets, ai_delay,Temp_scaler ,ai_delay_scaler

def Change_Reduced(time_list,temp_list,Y_target_list,Y_non_target_list,case,target,non_target,Time_Det,Scal_Target,Scal_Non_Target,Temp_scaler,ai_delay_scaler,param):
    ...
    if info_scal =="scaler" :
        ...
        ai_delay =standard_rdc_T(ai_delay,case,ai_delay_scaler)
    
    return time_list,temp_list,Y_target_list,Y_non_target_list , ai_delay 
    
def Sim0D(t_gas,gas_eq,fuel1,fuel2,oxidizer,case,dt,tmax,tol=0.5):
